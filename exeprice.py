...
:
print(
'Fonctionnalité "lister les todos" à venir'
)
...
:
print(
'Fonctionnalité "créer un todo" à venir'
)
...
:
print(
'Fonctionnalité "modifier le statut d\'un todo" à veni
r'
)
...
:
print(
'Fonctionnalité "supprimer un todo" à venir'
)
# Menu principal
choix =
''
